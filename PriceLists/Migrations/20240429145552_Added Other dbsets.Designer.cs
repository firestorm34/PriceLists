...
namespace PriceLists.Migrations
{
    ...
    [Migration("20240429145552_Added Other dbsets")]
    partial class AddedOtherdbsets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PriceLists.Models.ProductColumnValue", b =>
                {
                    b.HasOne("PriceLists.Models.Column", null)
                        .WithMany("ProductColumnValues")
                        .HasForeignKey("ColumnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PriceLists.Models.Product", null)
                        .WithMany("ProductColumnValues")
